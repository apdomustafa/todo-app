...
import 'package:todo_app2/features/auth/model/repos/login_repo.dart/login_with_email_pass.dart';
import 'package:todo_app2/features/auth/model/repos/login_repo.dart/login_with_google.dart';
...
class LoginBloc extends Bloc<LoginEvent, LoginState> {
  ...
  LoginBloc() : super(LoginInitial()) {
    ...
    on<LoginWithEmailAndPassEvent>((event, emit) async {
      ...
      _loginRepo =
          LoginWithEmailAndPass(email: event.userName, pass: event.pass);
