...
import 'package:todo_app2/features/auth/views/widgets/login_button.dart';
...
class _LoginViewState extends State<LoginView> {
              ...
              child: Column(
                ...
                children: [
                  ...
                  CustomTextFieldForm(
                    ...
                    Gkey: globalKey,
                    onchange: _customizeLoginButtonColorEmail,
                  ),
                  Gap(25.h),
                  Text(
                    'Passward',
  ...
  void _customizeLoginButtonColorEmail(String value, BuildContext context) {
    if (value.length == 1) {
